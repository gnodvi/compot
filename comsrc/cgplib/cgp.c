...
struct parameters {
  ...
  double (*fitnessFunction) (struct parameters *params, struct chromosome *chromo, 
                             struct dataSet *dat);
  char   fitnessFunctionName[FITNESSFUNCTIONNAMELENGTH];
  void   (*selectionScheme) (struct parameters *params, struct chromosome **parents, 
  ...
  void   (*reproductionScheme)(struct parameters *params, struct chromosome **parents, 
...
DLL_EXPORT 
void 
setEvolutionaryStrategy (struct parameters *params, char evolutionaryStrategy) 
{
...
void setCustomSelectionScheme (struct parameters *params, 
                               void (*selectionScheme)(struct parameters *params, struct chromosome **parents, struct chromosome **candidateChromos, 
                            int numParents, 
...
//------------------------------------------------------------------------------
/*
  sets the reproduction scheme used to select the parents from the candidate 
  chromosomes. If the reproductionScheme is NULL
  then the default mutateRandomParent selection scheme is used.
  */
//------------------------------------------------------------------------------
DLL_EXPORT 
void 
setCustomReproductionScheme (struct parameters *params, 
...
//------------------------------------------------------------------------------
DLL_EXPORT 
void setNumThreads (struct parameters *params, int numThreads) {
...
void printChromosome (struct chromosome *chromo, int weights) {
  ...
  fprintf (stderr, "............. printChromosome .............. \n");
  fprintf (stderr, "\n");
  ...
  fprintf (stderr, "numOutputs     = %d \n", chromo->numOutputs);
  fprintf (stderr, "numNodes       = %d \n", chromo->numNodes);
  fprintf (stderr, "numActiveNodes = %d \n", chromo->numActiveNodes);
...
//------------------------------------------------------------------------------
DLL_EXPORT int 
compareChromosomesActiveNodes (struct chromosome *chromoA, struct chromosome *chromoB) 
{
...
//------------------------------------------------------------------------------
DLL_EXPORT int 
compareChromosomesActiveNodesANN (struct chromosome *chromoA, struct chromosome *chromoB) {
...
/*
  ...
  */
//------------------------------------------------------------------------------
DLL_EXPORT struct results* repeatCGP (struct parameters *params, struct dataSet *data, 
  ...
  fprintf (stderr, "MEAN\t%f\t%f\t%f\n", getAverageFitness(rels), getAverageGenerations(rels), 
           getAverageActiveNodes(rels));
  fprintf (stderr, "MEDIAN\t%f\t%f\t%f\n", getMedianFitness(rels), getMedianGenerations(rels), 
           getMedianActiveNodes(rels));
...
//------------------------------------------------------------------------------
static void 
mutateRandomParent (struct parameters *params, 
                    struct chromosome **parents, 
                    struct chromosome **children, 
                    int numParents, int numChildren) {
...
/*
  ...
  */
//------------------------------------------------------------------------------
static void selectFittest (struct parameters *params, struct chromosome **parents, 
...
//------------------------------------------------------------------------------
static struct node *
initialiseNode (int numInputs, int numNodes, int arity, 
                int numFunctions, double connectionWeightRange, 
...
/*
  ...
  */
static double 
_divide (const int numInputs, const double *inputs, const double *connectionWeights) {
...
//------------------------------------------------------------------------------
static double 
_cosine (const int numInputs, const double *inputs, const double *connectionWeights) {
...
//------------------------------------------------------------------------------
static double 
_tangent (const int numInputs, const double *inputs, const double *connectionWeights) {
...
//------------------------------------------------------------------------------
static double 
_wire (const int numInputs, const double *inputs, const double *connectionWeights) {
...
//------------------------------------------------------------------------------
static double 
_sigmoid (const int numInputs, const double *inputs, const double *connectionWeights) {
...
//------------------------------------------------------------------------------
static double 
_step (const int numInputs, const double *inputs, const double *connectionWeights) {
...
//------------------------------------------------------------------------------
static double 
sumWeigtedInputs(const int numInputs, const double *inputs, const double *connectionWeights) {
...
//------------------------------------------------------------------------------
static double 
supervisedLearning (struct parameters *params, struct chromosome *chromo, 
                                  struct dataSet *data) 
{
...
//------------------------------------------------------------------------------
static void 
sortIntArray(int *array, const int length) {
...
//------------------------------------------------------------------------------
static void 
sortDoubleArray(double *array, const int length) {
...
// 
//------------------------------------------------------------------------------
DLL_EXPORT struct chromosome* 
runCGP (struct parameters *params, struct dataSet *data, int numGens) 
{
  ...
  for (i = 0; i < numCandidateChromos; i++) {
    ...
    fprintf (stderr, "initialise the candidateChromos: i = %d \n", i); // !!!!!!
  }
  ...
  for (i = 0; i < params->mu; i++) {
    ...
    fprintf (stderr, "set fitness of the parents: i = %d \n", i); // !!!!!!
  }
