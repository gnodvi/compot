/*******************************************************************************
 *                                                                             *
 *  Имя этого файла: c_memory_chunks.c                                         *
 *                                                                             *
  ******************************************************************************
 */  
...
static node_t	*node_remove (node_t *node, Key_t key, void **removed_data);
...
/*----------------------------------------------------------------------------*/
void 
mem_chunk_free_real (MemChunk *mem_chunk, void *mem)
{
  MemArea  *temp_area;
  FreeAtom *free_atom;
...
/*----------------------------------------------------------------------------*/
void 
mem_chunk_clean_real (MemChunk *mem_chunk)
{
  MemArea *mem_area;
...
/*----------------------------------------------------------------------------*/
void 
mem_chunk_reset_real (MemChunk *mem_chunk)
{
  MemArea *mem_areas;
  MemArea *temp_area;
...
/*----------------------------------------------------------------------------*/
static int 
memarea_check_bounds (MemChunk *mem_chunk, MemArea *mem_area)
{
  int		count = 0;
  unsigned char	*mem;
  int		index = 0;
...
/*----------------------------------------------------------------------------*/
boolean 
mem_chunk_check_all_bounds_real (MemChunk *mem_chunk)
{
  MemArea	*mem_area;
  int		badcount=0;
...
/*----------------------------------------------------------------------------*/
boolean 
mem_chunk_check_bounds_real (MemChunk *mem_chunk, void *mem)
{
  mem = BUMP_DOWN (mem);
...
/*----------------------------------------------------------------------------*/
void 
mem_chunk_diagnostics_real (void)
{
...
/*----------------------------------------------------------------------------*/
boolean 
  mem_chunk_isempty_mimic (MemChunk *mem_chunk)
{
...
/*----------------------------------------------------------------------------*/
MemChunk *
mem_chunk_new_mimic (size_t atom_size, unsigned int num_atoms)
{
  MemChunk  *mem_chunk;
...
/*----------------------------------------------------------------------------*/
MemChunk *
mem_chunk_new_unfreeable_mimic (size_t atom_size, unsigned int num_atoms)
{
...
/*----------------------------------------------------------------------------*/
boolean 
mem_chunk_has_freeable_atoms_mimic (MemChunk *mem_chunk)
{
...
/*----------------------------------------------------------------------------*/
void 
mem_chunk_destroy_mimic (MemChunk *mem_chunk)
{
...
/*----------------------------------------------------------------------------*/
void *
mem_chunk_alloc_mimic (MemChunk *mem_chunk)
{
  void	*mem;
...
/*----------------------------------------------------------------------------*/
void 
mem_chunk_clean_mimic (MemChunk *mem_chunk)
{
...
/*----------------------------------------------------------------------------*/
void 
mem_chunk_reset_mimic (MemChunk *mem_chunk)
{
...
/*----------------------------------------------------------------------------*/
void 
mem_chunk_diagnostics_mimic (void)
{
