/*******************************************************************************
 *                                                                             *
 *  Имя этого файла: c_linkedlist.c                                              *
 *                                                                             *
  ******************************************************************************
 */  
...
/*----------------------------------------------------------------------------*/
GAULFUNC boolean 
dlink_foreach_reverse (DLList *list, LLForeachFunc func, vpointer userdata)
{
...
/*----------------------------------------------------------------------------*/
GAULFUNC DLList *
dlink_insert_sorted (DLList *list, vpointer data, LLCompareFunc func)
{
  DLList *this_list;
  DLList *prev_list;
  DLList *new_element;
