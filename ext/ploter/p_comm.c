...
/*   (format t "bj_drawellps: ~A ~A ~A ~A ~A ~A  ~%" ch x y xcentre ycentre asp_ratio) */
/*   (format t "startx= ~A endx= ~A  ~%" startx endx) */
/*   (format t "starty= ~A endy= ~A  ~%" starty endy) */
/*   (format t "~%") */
/*   printf ("bj_drawellps: x=%d y=%d xcentre=%d ycentre=%d \n", x, y, xcentre, ycentre); */
...
/*----------------------------------------------------------------------------*/
void
MFOR_print_ijk (int *ijk, int dim, int index)
{
  int d;
