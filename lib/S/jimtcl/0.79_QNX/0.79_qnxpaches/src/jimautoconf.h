...
#define HAVE_STRUCT_STAT_ST_MTIMSPEC 1
...
// Gen: - странным образом это define, отрабатывая далее во
// включенном include портил работу функции Jim_ReaddirCmd в
// файле jim_readdir.c
//
// include "dirent.h"
// strict dirent (QNX)
...
//--------------------------------------------------
// And add this from "configure --full"
