...
# This script will click full-screen button on the embedded YouTube video. It 
# will create screenshot of the active window, scan it for the full-screen 
# button pattern and then move mouse and click that button.
