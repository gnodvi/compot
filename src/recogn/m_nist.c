 ...
 */
const char * train_images_file = "D/train-images-idx3-ubyte";
const char * train_labels_file = "D/train-labels-idx1-ubyte";

const char * test_images_file  = "D/t10k-images-idx3-ubyte";
const char * test_labels_file  = "D/t10k-labels-idx1-ubyte";
